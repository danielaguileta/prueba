...
@section('content')
<form action="{{route('retiro.index')}}" method="post">
    @csrf
    <div class="col-md-3"><br>
        <div class="card text-white bg-dark mb-3">
            <div class="card-header">
                <h4 class="card-title">Retirar</h4>
            </div>
            <div class="card-body">
                @csrf
                <div class="row">
                    ...
                    <div class="col-1">
                        <div class="form-group">
                        <strong><span class="hide" id="msg_rut" style="color:white;position: absolute;margin-top: 38px;">Lps</span></strong>
                        </div>
                    </div>
                </div>
